...
const Compare = () => {
  ...
  const fetchCampSelectionRate = () => {
    ...
    const selectedPatches = Object.keys(junglevalue.patch).filter(
      (key) => junglevalue.patch[key] === true
    );
    const selectedSeasons = Object.keys(junglevalue.season).filter(
      (key) => junglevalue.season[key] === true
    );
    const selectedOppSeasons = Object.keys(junglevalue.oppseason).filter(
      (key) => junglevalue.oppseason[key] === true
    );
    const champArr = Object.keys(junglevalue.champion).filter(
      (key) => junglevalue.champion[key] === true
    );
    const oppChampArr = Object.keys(junglevalue.oppchampion).filter(
    ...
    axiosRequest(
      ...
      function (e) {
        ...
        setOppTeamBlue(
          e["team2"].campRate.filter((team) => team.side === "blue")
        );
        setOppTeamRed(
          e["team2"].campRate.filter((team) => team.side === "red")
        );
                        ...
                        <tr>
                          ...
                          <td>
                            <S.table.TableData>
                              ...
                              <div>
                                <p>{`${(
                                  oppTeamCamp.jg_rates.split(",")[0] * 100
                                ).toFixed(2)}%`}</p>
                                <p>{`${
                                  oppTeamCamp.monsterids.split(",")[0]
                                }`}</p>
                              </div>
                            </S.table.TableData>
                          </td>
                            ...
                            <S.table.TableData>
                              ...
                              <div>
                                {!oppTeamCamp.jg_rates.split(",")[1] ? (
                                  ...
                                  <p>{`${(
                                    oppTeamCamp.jg_rates.split(",")[1] * 100
                                  ).toFixed(2)}%`}</p>
                                )}
                                {oppTeamCamp.monsterids.split(",")[1] ===
                                undefined ? (
