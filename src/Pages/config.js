...
// export const API2 = "http://nunu.gg:8903"; // 테스트 서버
export const API2 = "http://teamsnowball.co:5003"; // 테스트 서버
...
export const API5 = "http://teamsnowball.co:5002 ";

// 라이엇 최신 버전(json)
export const recentVersion = "12.3.1";
